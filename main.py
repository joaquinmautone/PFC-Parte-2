...
texto_de_prueba = ["En un lugar de la Mancha, de cuyo nombre no quiero acordarme, no ha mucho tiempo que vivía un hidalgo de los de lanza en astillero, adarga antigua, rocín flaco y galgo corredor. Una olla de algo más vaca que carnero, salpicón las más noches, duelos y quebrantos los sábados, lantejas los viernes, algún palomino de añadidura los domingos, consumían las tres partes de su hacienda. El resto della concluían sayo de velarte, calzas de velludo para las fiestas, con sus pantuflos de lo mesmo, y los días de entresemana se honraba con su vellorí de lo más fino. Tenía en su casa una ama que pasaba de los cuarenta, y una sobrina que no llegaba a los veinte, y un mozo de campo y plaza, que así ensillaba el rocín como tomaba la podadera. Frisaba la edad de nuestro hidalgo con los cincuenta años; era de complexión recia, seco de carnes, enjuto de rostro, gran madrugador y amigo de la caza. Quieren decir que tenía el sobrenombre de Quijada, o Quesada, que en esto hay alguna diferencia en los autores que deste caso escriben; aunque por conjeturas verosímiles se deja entender que se llamaba Quijana. Pero esto importa poco a nuestro cuento: basta que en la narración dél no se salga un punto de la verdad."
...
def leerArchivo():
  lista = input("Ingrese el elemento que desea agregar: ")
  elemento = input("Ingrese el elemento que desea buscar: ")
  print(operaciones.leer_archivo(lista, elemento))

def buscarPalabraEnLinea():
  elemento = "enamorado" # mi CI termina en 9
  print(operaciones.buscar_palabra_en_linea(texto_de_prueba, elemento))

#Mostramos el menu en la consola
def mostrar_menu(opciones):
    print('Ingrese un item del menú')
    for i in sorted(opciones):
        print(f' {i}) {opciones[i][0]}')

#Leemos la opcion ingresada en la consola
def leer_opcion(opciones):
    while (a := input('Opción: ')) not in opciones:
        print('Opción incorrecta, vuelva a intentarlo.')
    return a

#Funcion para ejecutar el metodo asociado a la opcion seleccionada
def ejecutar_opcion(opcion, opciones):
    opciones[opcion][1]()

#Generamos el menu a mostrar
...
def menu_principal():
    opciones = {
        '1': ('Saber si un elemento está o no en la lista', leerArchivo),
        '2': ('Buscar palabra en linea', buscarPalabraEnLinea),
        '3': ('Salir', salir)
    }
